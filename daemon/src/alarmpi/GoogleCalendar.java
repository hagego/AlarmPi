...
public class GoogleCalendar {
	...
	// when deployed on raspberry this directory must be copied into the /etc/alarmpi folder
	private static final String TOKENS_PATH_DEVELOPMENT = "googleCalendarTokens";
	private static final String TOKENS_PATH_DEPLOYED    = "/etc/alarmpi/googleCalendarTokens";
	...
	public boolean connect() {
		...
		InputStream in = classloader.getResourceAsStream("GoogleCalendarCredentials.json");
		if (in == null) {
